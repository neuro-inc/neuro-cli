...
class TestCopyRecursivePlatformToLocal:
    ...
    def test_ok(self,
        ...
        transfer_mock.assert_any_call('/alice/platform_existing/my_file.txt',
    ...
    def test_ok_copy_bob_data(self,
        ...
        op = CopyOperation.create('alice', 'storage', 'file', True)
        op.copy_file = transfer_mock
        op.copy(urlparse('storage://bob/'),
                urlparse('file:///localdir/dir/'), partial_mocked_store)

        assert transfer_mock.call_count == 1
        transfer_mock.assert_any_call('/bob/bob_data/file.model',
...
class TestCopyNonRecursivePlatformToLocal:
    ...
    def test_source_file_target_specified(self,
                                          mocked_store, partial_mocked_store,
                                          monkeypatch):
        self._structure(mocked_store, monkeypatch)
        transfer_mock = Mock()
