...
Push an image to platform registry.<br/>Remote image must be URL with image:// scheme.<br/>Image names can contains tag. If tags not specified 'latest' will be used as value.
...
Pull an image from platform registry.<br/>Remote image name must be URL with image:// scheme.<br/>Image names can contain tag.
